...
function getWeatherdata(userInput) {
  ...
  fetch(
    ...
    .then(function (latLonData) {
      return fetch(
        `https://api.openweathermap.org/data/2.5/forecast?units=imperial&lat=${latLonData.lat}&lon=${latLonData.lon}&appid=${apiKey}`
      )
        .then(function (response) {
          return response.json();
        })
        .then(function (data) {
          ...
          feelsLike.textContent =
            "feels Like: " + weatherArray[0].main.feels_like + "F";
          humidity.textContent =
            "Humidity " + weatherArray[0].main.humidity + "%";
          windSpeed.textContent =
            "Wind Speed " + weatherArray[0].wind.speed + "mph";
          let cityDay = document.getElementById("cityDay");
          cityDay.textContent =
            weatherInfo.city.name + " (" + weatherArray[0].dt_txt + ")";
          ...
          icon1.src =
            "https://openweathermap.org/img/w/" +
            weatherInfo.list[7].weather[0].icon +
            ".png";
          ...
          wind1.textContent =
            "wind speed:" + weatherArray[1].wind.speed + "mph";
          ...
          icon2.src =
            "https://openweathermap.org/img/w/" +
            weatherInfo.list[15].weather[0].icon +
            ".png";
          ...
          wind2.textContent =
            "wind speed:" + weatherArray[2].wind.speed + "mph";
          ...
          icon3.src =
            "https://openweathermap.org/img/w/" +
            weatherInfo.list[23].weather[0].icon +
            ".png";
          ...
          wind3.textContent =
            "wind speed:" + weatherArray[3].wind.speed + "mph";
          ...
          icon4.src =
            "https://openweathermap.org/img/w/" +
            weatherInfo.list[30].weather[0].icon +
            ".png";
          ...
          wind4.textContent =
            "wind speed:" + weatherArray[4].wind.speed + "mph";
          ...
          icon5.src =
            "https://openweathermap.org/img/w/" +
            weatherInfo.list[39].weather[0].icon +
            ".png";
          ...
          wind5.textContent =
            "wind speed:" + weatherArray[5].wind.speed + "mph";
